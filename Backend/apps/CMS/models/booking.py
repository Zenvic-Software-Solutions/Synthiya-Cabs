...
from apps.CMS.models import Vechile, OtherCab,  OtherDriver
...
class Booking(BaseModel):
    ...
    sponsor = models.ForeignKey(Customer, on_delete=models.SET_NULL, related_name="sponsored_bookings", null=True, blank=True)
